...
10. 관측 자료에서 비교 대상을 찾는다는 것
11. 도구변수: 처치를 움직이는 외부 변화
12. 순응하지 않는 사람과 국소 효과
13. 비슷한 사람끼리 비교하기
14. 처치받을 가능성으로 균형 맞추기
15. 두 모델로 버티는 추정
16. 시간 변화로 비교하기
17. 보이지 않는 고정 차이 제거하기
18. 가상의 비교 대상 만들기
19. 경계선 근처에서 비교하기

### 4부. 예측을 정책으로 바꾸기

20. 예측 모델은 언제 정책에 도움이 되는가
21. 평균 효과에서 개인별 효과로
22. 누구에게 처치할지 정하는 문제
23. 인과 모델은 어떻게 평가하는가
24. 기존 머신러닝 모델로 효과 추정하기
25. S/T/X learner로 개인별 효과 추정하기
26. 예측이 실패하는 정책 상황

### 5부. 유연한 모델을 안전하게 쓰기

27. 머신러닝이 인과추론에서 만드는 편향
28. nuisance 모델과 target 효과 구분하기
29. orthogonalization 직관
30. cross-fitting은 왜 필요한가
31. 비선형성과 이질적 효과의 함정
32. DID가 깨지는 이유와 현대 DID
33. Synthetic DID
34. Synthetic control의 불확실성
