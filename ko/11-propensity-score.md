...
```text
조건들이 두 사람을 비싼 마우스 구매 쪽으로 미는 힘이 비슷하다면,
그 둘을 비교하는 것이 조금 더 낫지 않을까?
```
...
여러 조건이 마우스 구매에 미치는 방향을 합쳐서, “이 사람은 비싼 마우스를 얼마나 살 법했나?”를 보는 점수다.
...
이 점수는 사람을 고르기만 위한 점수가 아니라, 비교할 두 사람이 얼마나 비슷한 구매 성향에 있었는지 보기 위한 점수다.
...
효과를 읽기 전에 비교할 사람들을 더 비슷하게 만드는 장치다.
