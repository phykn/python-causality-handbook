...
아래 코드는 T learner의 계산 모양만 아주 작게 흉내 낸 것이다.

실제 머신러닝 모델 대신, 이미 만들어진 두 예측값을 사용한다.

```python
pc = "B"

predicted_if_treated = 66
predicted_if_control = 59

estimated_effect = predicted_if_treated - predicted_if_control

print(pc, estimated_effect)
```
