...
## 예측이 잘 되는 변수가 효과 변수처럼 보일 수 있다

여기서 더 헷갈리는 일이 생긴다.

어떤 변수는 새 마우스 효과를 직접 바꾸지 않는다.
...
이때 기존 승률은 효과를 직접 바꾸는 원인이 아닐 수 있다.
...
## 낮은 전환율에서는 높은 가능성 그룹이 좋아 보일 수 있다
...
그래서 평균 전환율이 낮은 서비스에서는 `원래 전환 가능성이 조금 높은 사람`이 더 좋은 대상처럼 보일 수 있다.

여기서 중요한 것은 “높은 사람에게 무조건 주자”가 아니다.

현재 서비스가 S자 곡선의 어느 쪽에 있는지 봐야 한다는 것이다.

낮은 쪽에 몰려 있으면, 너무 낮은 사람보다 어느 정도 가능성이 있는 사람이 더 움직일 수 있다.

## 높은 전환율에서는 반대가 될 수 있다
...
그래서 평균 전환율이 높은 서비스에서는, 너무 높은 가능성 그룹보다 중간에 가까운 그룹이 더 좋아 보일 수 있다.
...
즉 효과는 고객 유형뿐 아니라 현재 가격 수준에도 달라질 수 있다.
...
그래서 양이 있는 처치에서는 “이 고객은 가격에 민감하다”라는 말도 조심해야 한다.

어느 가격 구간에서 민감한지까지 봐야 한다.
...
이 상태에서 A가 더 민감하다거나 B가 더 민감하다고 말하면 위험하다.

고객 유형 차이 때문인지, 가격 구간 차이 때문인지 구분하기 어렵기 때문이다.

그래서 비선형 문제가 있을 때는 이 질문을 먼저 해야 한다.
...
효과가 달라 보일 때는 집단이 정말 다르게 반응한 것인지, 아니면 결과가 0%와 100% 사이에 막혀 있거나 처치 구간이 달라서 그렇게 보이는 것인지 먼저 구분해야 한다.
