...
그냥 숫자 차이를 더하면 큰 단위를 가진 조건이 너무 큰 힘을 갖는다.
...
예를 들어 마우스를 바꾼 뒤 생긴 손목 피로를 기준으로 사람을 맞추면, 마우스 효과가 지나가는 길 일부를 지워 버릴 수 있다.
...
사람을 여러 조건으로 하나하나 맞추는 대신, “처치를 받을 가능성” 하나로 묶어 본다.
