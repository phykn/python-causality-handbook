# 14장. 같은 PC방을 여러 번 보면 무엇을 뺄 수 있을까

## PC방마다 원래 다르다

13장에서는 일부 PC방에만 새 마우스를 설치했다.
...
![PC방별 평균을 빼서 원래 수준 차이를 제거한다](assets/14-fixed-effects-demeaning.png)
...
이번 장에서는 같은 대상을 여러 번 보면 무엇을 뺄 수 있는지 봤다.
